...
<?php
               ...
               $_SESSION['contractID']=NULL;
                  ...
                  ////rooms details
                   ...
                   for ($i = 0; $i <count($dataObj->arrRooms); $i++) {
                       $arrRooms[$i]=array(
                       "HouseType" => $dataObj->arrRooms[$i][0],
                       "BedType" => $dataObj->arrRooms[$i][1],
                       "RoomType" => $dataObj->arrRooms[$i][2]
                       );
                   }
                 ...
                 //  print_r($arrPayment);
                   ...
                   try {
                      ...
                      // echo $clientid;
                       ...
                       //echo 'client';
                   //   print_r($clientArray);
                   $result=array("error"=>$e->getMessage(),"errorMassege"=>$e,"bmbyCode"=> $client->__getLastResponse(),"data"=>$clientid);
    ...
    // echo $client->__getLastResponse();
                  ...
                  //if not paying in site
                   ...
                   $result=array("error"=>$e->getMessage(),"errorMassege"=>$e,"bmbyCode"=> $client->__getLastResponse(),"data"=>$contractID);
                   echo json_encode($result);
                       return "";
                   }
