...
<?php
        ...
        function payInPelecard(){
            ...
            echo do_shortcode('[pelecard_pay_button value="1" item_name=" כניסה לועידה - עיר הנדלן '.$contractId.'" button_class="my-class" button_text="Pay Now"]'); 
