		...
		<div id="ef-options-updated" class="updated fade">
			...
			<header class="ef-options-header">
				...
				<div class="ef-about">
					...
					<p>Developed by <a href="http://www.eventmanagerblog.com/store" target="_blank">Event Manager Blog</a></p>
				</div><!-- /about -->
			...
			<nav class="el-options-links">
				<ul>
					...
					<li><a href="#">View Theme Documentation</a></li>
					<li class='el-save el-button'><a id="ef-save-options" href="#">Save options</a></li>
				</ul>
