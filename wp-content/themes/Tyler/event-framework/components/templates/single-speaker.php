            ...
            <div class="container">
                ...
                <div class="nav">
                    ...
                    <?php if (!empty($full_speakers_url)) { ?>
                        <a href="<?php echo $full_speakers_url; ?>" title="<?php _e('All', 'dxef'); ?>"><i class="icon-th-large"></i></a>
                    <?php } ?>
        ...
        <div class="container">
                        ...
                        if ($session_speakers && is_array($session_speakers) && in_array($speaker_id, $session_speakers)) {
                            ...
                            <div class="session">
                                <a href="<?php the_permalink(); ?>" class="session-inner">
                                    ...
                                    <span class="more">
                                        <?php _e('View session', 'dxef'); ?> <i class="icon-angle-right"></i>
                                    </span>
                                </a>
                            </div>
                            <?php
            ...
            <?php if (!empty($full_schedule_url)) { ?>
                <p class="visible-xs text-center">
                    <a href="<?php echo $full_schedule_url; ?>" class="btn btn-primary btn-header"><?php _e('View full schedule', 'dxef'); ?></a>
                </p>
            <?php } ?>
        </div>
        <?php
