   ...
   ?>
    <form id="nadlan-register-form">
            ...
            <div class="row">
                <div class="col-sm-11">
                    ...
                    <select id="register-start-day">
                        ...
                        <option value="1">17/11/2014 - יום ב'</option>
                        <option value="2">18/11/2014 - יום ג'</option>
                        <option value="3">19/11/2014 - יום ד'</option>
                        <option value="4">20/11/2014 - יום ה'</option>
                    </select>
                </div>
            </div>
            <div class="row">
        ...
        <div class="register-step" id="step-3">
            ...
            <div id="payment1">
                <label>תשלום מס' 1</label></label><br>
      ...
      חזון</option>
            ...
            <div id="payment2">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input id="registrationPhone2" type="text" value="" placeholder="טל' לבירורים בענייני הפקת החשבונית">
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <select id="registrationAddressCity2">
                            <option value="61">צפת</option>
                            <option value="62">קרית
      שמונה</option>
                            <option value="395">כפר
      ...
      חזון</option>
                    ...
                    <div class="col-sm-6">
                        <input id="registrationAddressStreet2" type="text" value="" placeholder="רחוב ומספר">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <input id="registrationAddressZip2" type="text" value="" placeholder="מיקוד">
                    </div>
                </div>
            </div>
            ...
            <div id="payment3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input id="registrationPhone3" type="text" value="" placeholder="טל' לבירורים בענייני הפקת החשבונית">
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <select id="registrationAddressCity3">
                            <option value="61">צפת</option>
                            <option value="62">קרית
      שמונה</option>
                            <option value="395">כפר
      ...
      חזון</option>
                    ...
                    <div class="col-sm-6">
                        <input id="registrationAddressStreet3" type="text" value="" placeholder="רחוב ומספר">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <input id="registrationAddressZip3" type="text" value="" placeholder="מיקוד">
                    </div>
                </div>
            </div>
