...
<div class="container">
    <?php echo do_shortcode('[pelecard_pay_button value="0.90" item_name="כניסה לועידה - עיר הנדלן" button_class="my-class" button_text="Pay Now"]')  ?>
    ...
    <form id="nadlan-register-form">
            ...
            <div id="details1">
                ...
                <div class="row">
                    <div class="upload-imag-icon">
                        <input id="upload-imag1" type="file" value="">
                    </div>
                </div>
            </div>
            <div id="details2">
        ...
        <div class="register-step" id="step-3">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <select id="registrationAddressCity">
  ...
  חזון</option>
                ...
                <div class="col-sm-6">
                    <input id="registrationAddressStreet" type="text" value="" placeholder="רחוב ומספר">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <input id="registrationAddressZip" type="text" value="" placeholder="מיקוד">
                </div>
            </div>
            <div id="register-paypment-area">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <button id="siugnUp" class="btn btn-secondary">הרשם ושלם באמצעים אחרים</button>
                    </div>
                    <form></form>
